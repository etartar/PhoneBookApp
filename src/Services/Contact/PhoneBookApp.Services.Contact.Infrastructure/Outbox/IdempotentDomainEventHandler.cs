...
namespace PhoneBookApp.Services.Contact.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM public.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO public.outbox_message_consumers(outbox_message_id, name)
